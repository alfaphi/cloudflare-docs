...
Loopback requests may also be blocked by [I’m Under Attack mode](/support/firewall/settings/understanding-cloudflare-under-attack-mode-advanced-ddos-protection/) or certain [WAF custom rules](/waf/custom-rules/).
