...
To get bot requests identified correctly, use only one WAF custom rule, configured with the action _Interactive Challenge_. To learn more about custom rules, refer to the [WAF documentation](/waf/custom-rules/).
