...
To block traffic on ports other than 80 and 443, create a [WAF custom rule](/waf/custom-rules/) for this purpose. For example, you could use a rule configuration similar to the following:
